...
<img src="/Building-Trustworthy-AI-Agents/images/hero-security.svg" alt="Input Validation" style="width: 100%; max-height: 250px; object-fit: cover; border-radius: 8px; margin-bottom: 2em; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);" role="img" aria-label="Input Validation Hero Image">
...
<ul>
<li><a href="https://learn.microsoft.com/en-us/azure/security/develop/threat-modeling-tool-input-validation" target="_blank" rel="noopener">Input validation mitigations</a></li>
