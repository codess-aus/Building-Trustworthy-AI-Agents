...
<img src="/Building-Trustworthy-AI-Agents/images/hero-security.svg" alt="Security Considerations" style="width: 100%; max-height: 250px; object-fit: cover; border-radius: 8px; margin-bottom: 2em; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);" role="img" aria-label="Security Considerations Hero Image">
...
<img src="../images/SecurityasCoreDesign.png" alt="Security as Core Design Principle" style="max-width: 800px; margin: 20px 0;" />
...
<img src="../images/RiskMitigationLayers.png" alt="Risk Mitigation Layers" style="max-width: 800px; margin: 20px 0;" />
